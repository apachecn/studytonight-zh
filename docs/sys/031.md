> 原文:[https://www . study south . com/operating-system/最短剩余时间优先调度算法](https://www.studytonight.com/operating-system/shortest-remaining-time-first-scheduling-algorithm)
