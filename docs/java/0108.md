...
字符类是一个包装器，用于包装对象中基本类型字符的值。字符类的对象包含一个类型为字符的字段。
...
此方法用于确定指定字符是否为字母。它返回真或假的布尔值。如果字符是字母，则返回 true，否则返回 false。它采用单个字符类型参数。下面给出了该方法的一般语法。
...
![character-class-example](../Images/286c1e7381604ccbe92a92497c988f84.png)

### 2.isdigt(char ch)

字符类提供了一个`isDigit()`方法来确定指定的字符是否是数字。如果指定的字符是数字，则返回 true，否则返回 false。

它采用单个字符类型参数。下面给出了该方法的一般语法。
...
![character-class-example](../Images/66a8c4c72d099ee6cbd135c9b9c6a336.png)
...
![character-class-example](../Images/23af9da24001c40b5d90dfabb6d61b31.png)
...
![character-class-example](../Images/f016588782f1f67c1cd79c5bc4d971a0.png)
...
![character-class-example](../Images/2ede6ff424cc166f4feb9f8c0e063745.png)
...
![character-class-example](../Images/a7c8f80c481e57f5243965056ce6bae3.png)

### 7.托勒温案(char ch)

此方法用于将字符参数转换为小写字母。它在转换为小写后返回一个字符。它采用单字符类型参数。该方法的声明如下。
...
![character-class-example](../Images/bd1e4053813090b20b769d14bd6a139e.png)
...
![character-class-example](../Images/f416bb8702047e724655e122eef9c7b5.png)
...
![character-class-example](../Images/3fa1eca55bc9072846779483c5b78c66.png)
...
![character-class-example](../Images/125b12616dc371ff2e850ae619f7c567.png)
