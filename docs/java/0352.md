...
![A graph of cities](../Images/c5b2c1acf8060ba2e064e0260237b661.png)
...
![Adjacency Matrix](../Images/8a67f70175dfff9a79366a5e8c73a9ca.png)

### 邻接表

邻接表仅仅是一组列表。数组的长度等于节点的数量。为阵列中的每个节点维护一个列表，该列表包含与我们的节点直接连接的节点。邻接表使用起来更复杂，但提供了更好的空间效率。

![Adjacency List](../Images/8223109ae5455ff854b2445b423ce3aa.png)
...
![Example Graph](../Images/96d2172ee1d4ab5bf4b71611cb214f68.png)
