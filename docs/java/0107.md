...
![boolean-class-example](../Images/15b7130ea859d8d2a78bef5d5c085555.png)
...
![boolean-class-example-1.JPG](../Images/664fbe29231ef8a5267a0a05a33d9df3.png)
...
![boolean-class-example](../Images/1379b8ee54d0c2f534dc009e5f4eed5e.png)
...
![boolean-class-example-3.JPG](../Images/afb5526efc3889f67f0fe87db39cfbfb.png)
...
![boolean-class-example](../Images/c522d6b1e0968b826d2dc9f3b0a05479.png)
...
![boolean-class-example](../Images/98e6f3958cc68b087b62bfa62b7a19f2.png)
...
![boolean-class-example](../Images/7f1a782d2e5878a7d87f3852e9d401f2.png)
...
![boolean-class-example-7.JPG](../Images/2645fe72e2af96e01dd4bab51200bde4.png)

### 9.比较

`compareTo()`方法用于比较一个布尔实例和另一个布尔实例。此方法在接受布尔类型的单个参数的可比接口中指定。
...
![boolean-class-example](../Images/c3d77aa21f66236984865666990d4d57.png)
...
![boolean-class-example](../Images/a92df71636050517cc3c26a24be003af.png)
