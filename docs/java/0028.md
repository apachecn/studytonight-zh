...
Java 支持方法重载，并且总是发生在同一个类中(与方法重写不同)。
...
Java 支持自动类型提升，如 int 到 long 或 float 到 double 等。在这个例子中，我们做同样的事情，并调用一个函数，该函数接受一个整数和第二个长类型参数。在调用时，我们传递了整数值，Java 将第二个参数视为长类型。见下面的例子。
...
![parameter-different-method-overloading](../Images/8f28894ce3bbbe272919bb53207ec399.png)
...
![overloading-main](../Images/f648059918735d7efafb5ab25363471b.png)
...
![method-overloading-null-error](../Images/d7ab0b9d50d7a4cdc7e43abda7c2b0a4.png)
