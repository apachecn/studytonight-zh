...
![double-class](../Images/dbda515abe3d95ba736dbffd73f9df02.png)

### 2.valueOf()

此方法返回一个表示指定双精度值的 Double 实例。此方法通常应优先于构造函数 Double(double)使用。它需要双类型的单个参数。
...
![double-class-example](../Images/727e50852e382eeeabde5f46b16b24b2.png)

### 3.parseDouble()

此方法返回指定字符串值的双精度值。我们可以用它从字符串类型值中获取一个双精度值。它只接受一个字符串类型的参数。
...
让我们举一个例子，其中我们有一个字符串类型的变量，并使用`parseDouble()`方法获得它的双精度值。
...
![double-class-example](../Images/286c1da38d3751430676c2ba4061b723.png)
...
`longValue()`方法在扩展原语转换后，将该 Double 类型的值作为长类型返回。下面给出了该方法的语法。
...
此方法用于在扩展基元转换后将此 Double 类型的值作为浮点类型获取。下面给出了该方法的语法。
...
![double-class-example](../Images/fee47e5d2fdaaa58bc4b2c24d885c042.png)

### 10\. hashCode()

此方法用于获取双类型值的哈希代码。它返回一个双对象的 int 值。
...
![double-class-example](../Images/9e821d1208f3a825daf41e648fb3980d.png)
...
![double-class-example](../Images/f1a765e697f737296782766637d6fdfe.png)
...
![double-class-example](../Images/3e2d81213453670cf837910cf896658e.png)

### 13\. 十六进制字符串（）

此方法用于获取双参数的十六进制字符串表示形式。它采用双类型参数，该参数将被转换为十六进制值。下面给出了该方法的语法。
...
![double-class-example](../Images/57753640e8d484b1080aa8d785e8bf26.png)
...
![double-class-example](../Images/15bc77efb98fe784f4f4c2947d2325e2.png)
...
![double-class-example](../Images/69cc9fe5b7f5f65f8de40ec636948574.png)
...
![double-class-example](../Images/1bd9b27c690ae532ca9a5e2ae1ca6eb6.png)
...
![double-class-example](../Images/db662c3b15dd16375ae2682a860d3df1.png)
...
![double-class-example](../Images/5935a38c60e56436577b101f22223fcc.png)
...
![double-class-example](../Images/334c02e1d7948bac5e5c4fd96d34ba2f.png)
