> 原文:[https://www . study south . com/kot Lin/kot Lin-环境-设置](https://www.studytonight.com/kotlin/kotlin-environment-setup)
...
![install and setup IntelliJ IDEA for Kotlin](../Images/186e75f6e337376e85c3f616e102811c.png)

*   现在，选择您的操作系统并下载社区版本，如上图所示。

*   运行下载的可执行文件。您将看到此屏幕:

    ![setup Intellij IDEA for Kotlin](../Images/d3affa932f813346b10670942d9abfb8.png)
...
*   现在，将出现此窗口:
    ...
    ![setup Kotlin environment](../Images/59387d1a99f5843eb96b29682985730f.png)
...
*   第一步是下载 Kotlin 编译器。打开[这个](https://github.com/JetBrains/kotlin/releases/tag/v1.3.72) github 链接。你会看到这样的东西:
    ...
    ![setup command line compiler for Kotlin](../Images/80c489a3d8df098c2130042066dcfe92.png)

    向下滚动并从资产部分下载“kotlin-编译器-xx”，如下所示:

    ![setup command line compiler for Kotlin](../Images/a5c911c37d4e0ceb794772af726ce742.png)
...
*   该窗口将被打开:
    ...
    ![setup command line compiler for Kotlin](../Images/327533cd120ca864bb37a7febc135a14.png)
...
*   打开[这个](https://www.oracle.com/in/java/technologies/javase-downloads.html)链接下载 Java 开发工具包。你会看到一个类似这样的窗口:< =/p >
    ...
    ![setup command line compiler for Kotlin](../Images/332aba298cf92bdd4dfe95b5f0d15c62.png)

*   点击“JDK 下载”(用红色箭头标记)。将会打开一个新窗口。

*   根据您的操作系统向下滚动并下载合适的安装程序。对于 windows，请选择此选项:

    ![setup command line compiler for Kotlin](../Images/69cfa3d763d7d60aed2bf881e5648707.png)
...
![setup command line compiler for Kotlin](../Images/491b04e9db3211dded6288b9f60e573a.png)
