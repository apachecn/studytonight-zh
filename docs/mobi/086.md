> 原文:[https://www.studytonight.com/kotlin/kotlin-inline-keyword](https://www.studytonight.com/kotlin/kotlin-inline-keyword)
...
在本教程中，我们将使用`inline`关键字讨论柯特林中的内联函数。内联函数帮助我们在运行时节省内存，从而提高应用程序的性能。
