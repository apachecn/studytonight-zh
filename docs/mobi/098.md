> 原文:[https://www.studytonight.com/kotlin/kotlin-enum](https://www.studytonight.com/kotlin/kotlin-enum)

[← Prev](/kotlin/kotlin-data-class "Kotlin Data Class")[Next →](/kotlin/kotlin-sealed-class "Kotlin Sealed Class")

# 科特林枚举

在本教程中，我们将了解 Kotlin Enum。在开发应用程序时，可能会出现这样一种情况，即我们希望一个变量只具有一组给定的允许值，例如，如果我们有一个变量`pizzaSize`，那么它应该具有以下值:小、中、大。
