...
在之前的教程中，我们了解了[Spring安全](https://www.studytonight.com/spring-framework/spring-security-introduction)并创建了一个[基本Spring安全](https://www.studytonight.com/spring-framework/basic-example)应用。现在，我们将学习创建自己的登录页面来验证用户。
