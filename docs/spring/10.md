...
在本主题中，我们将学习创建一个字符串应用程序，并使用 XML 代码对其进行配置。让我们创建一个 maven 项目，并使用 XML 文件对其进行配置。如果你不熟悉 maven 项目，那么你可以在这里阅读我们的详细文章[。](https://www.studytonight.com/spring-framework/spring-maven-project)
...
![Spring XML Based Configuration](../Images/1f70df0a2e1e466fbd9e5a3371dfc6f3.png)
