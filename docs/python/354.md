...
在本教程中，我们将学习[Python](https://www.studytonight.com/python/getting-started-with-python)Pandas`DataFrame.copy()`的方法。此方法复制数据帧的数据并返回一个新对象。下图显示了 Python Pandas`DataFrame.copy()`方法的语法。
