# Pandas数据帧`multiply()`方法

> 原文：<https://www.studytonight.com/pandas/pandas-dataframe-multiply-method>

在本教程中，我们将讨论和学习[Python](https://www.studytonight.com/python/getting-started-with-python)Pandas`DataFrame.multiply()`的方法。该方法用于获取数据帧和其他元素的乘积。它返回一个带有乘法运算结果的数据帧。
...
在本教程中，我们学习了 Python Pandas`DataFrame.multiply()`方法。我们学习了该方法的语法和参数，并将其应用于数据帧。
