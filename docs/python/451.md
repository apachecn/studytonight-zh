...
如果我们想合并两个系列，我们可以使用 Python Pandas`Series.append()` 方法，该方法合并或连接两个系列并返回一个新的系列。
...
在本教程中，我们学习了PythonPandas`DataFrame.append()`法。我们理解了`DataFrame.append()`方法的语法和参数，并通过将该方法应用于系列来解决示例。
