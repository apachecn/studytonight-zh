> 原文:[https://www . study south . com/CPP-programs/CPP-find-sum-n-numbers-由用户输入](https://www.studytonight.com/cpp-programs/cpp-find-sum-of-n-numbers-entered-by-the-user)
