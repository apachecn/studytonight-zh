> 原文:[https://www . study south . com/CPP-programs/CPP-check-如果数组包含任何重复项](https://www.studytonight.com/cpp-programs/cpp-check-if-the-array-contains-any-duplicates)
