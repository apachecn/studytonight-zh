> 原文:[https://www . study south . com/advanced-数据结构/图表示-邻接矩阵和列表](https://www.studytonight.com/advanced-data-structures/graph-representations-adjacency-matrix-and-list)
