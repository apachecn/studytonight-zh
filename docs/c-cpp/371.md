...
![Binary Search Tree](../Images/15b733b5c4d9858e1d8d404e1b6e8bd8.png)
...
![Binary Search Tree](../Images/1702efcee34af075e21ce4e684cc1b5b.png)
...
![Binary Search Tree](../Images/45a4aa3881a05eeedc05480fb6001a51.png)

搜索和插入的时间复杂度取决于树的高度。平均来说，有 n 个节点的二分搜索法树有 **O(log n)** 的高度。然而，在最坏的情况下，当不平衡的树类似于链表时，树的高度可以是**0(n)**。例如，在这种情况下:

![Binary Search Tree](../Images/009e7c5c918b2186c2533994826d5f47.png)
